...
func TestBackend(t *testing.T) {
	...
	if s := b.String(); s != `{"type":"gauge","name":"log.events.level","help":"yay!","value":1,"sample":1,"tags":{"hello":"world"}}
{"type":"counter","name":"log.events.count","value":1,"sample":1,"tags":{"hello":"world"}}
{"type":"histogram","name":"log.events.duration","value":1000000000,"sample":1,"tags":{"hello":"world"}}
` {
