...
import (
	_ "github.com/segmentio/stats/v5/util/objconv/adapters/net"
	_ "github.com/segmentio/stats/v5/util/objconv/adapters/net/mail"
	_ "github.com/segmentio/stats/v5/util/objconv/adapters/net/url"
)
